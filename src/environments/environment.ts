...
export const environment = {
  ...
  apiUrl: 'https://backend.dev.liftme.pro/',
  fileUrl: 'https://backend.dev.liftme.pro/files',
  socketUrl: 'https://direct.dev.liftme.pro/direct',
  articleFilesUrl: 'https://backend.dev.liftme.pro/static/',
  socketIG: 'https://backend.dev.liftme.pro',
  ...
  limit: 10,
  loginName: 'test@test.ru',
  loginPasswd: 'Andrey706',
  isRestricted: false
